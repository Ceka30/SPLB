...
@CHILE_Recomendador_DuoTriplePack
Scenario Outline: Recomendador Duo Triple Pack 
    ...
    @CHILE_Recomendador_DuoTriplePack_Fibra600TVLite
    Examples:
    ...
    @CHILE_Recomendador_DuoTriplePack_Fibra600TVFullPlus
    Examples:
        | URL                          | SERVICIO    | TIPO_HOGAR   | PISOS_HOGAR   | ESPACIOS         | DISPOSITIVOS              | UTILIZACION | TVS                  | PLAN_IDEAL          |
    ...
    @CHILE_Recomendador_DuoTriplePack_Fibra800TVLite
    Examples:
        | URL                          | SERVICIO    | TIPO_HOGAR   | PISOS_HOGAR   | ESPACIOS         | DISPOSITIVOS              | UTILIZACION | TVS                  | PLAN_IDEAL          |
    ...
    @CHILE_Recomendador_DuoTriplePack_Fibra800TVFullPlus
    Examples:
        | URL                          | SERVICIO    | TIPO_HOGAR   | PISOS_HOGAR   | ESPACIOS         | DISPOSITIVOS              | UTILIZACION | TVS                  | PLAN_IDEAL          |
    ...
    @CHILE_Recomendador_DuoTriplePack_FibraGigaTVLite
    Examples:
        | URL                          | SERVICIO    | TIPO_HOGAR   | PISOS_HOGAR   | ESPACIOS         | DISPOSITIVOS              | UTILIZACION | TVS                  | PLAN_IDEAL          |
    ...
    @CHILE_Recomendador_DuoTriplePack_FibraGigaTVFullPlus
    Examples:
        | URL                          | SERVICIO    | TIPO_HOGAR   | PISOS_HOGAR   | ESPACIOS         | DISPOSITIVOS              | UTILIZACION | TVS                  | PLAN_IDEAL          |
...
@CHILE_Recomendador_MonoPack_Television
...
@CHILE_Recomendador_MonoPack_Internet
